...
$sql="INSERT INTO vigia.usuario (usuario, pass, nombre, telefono, email, fecha_reg, perfil_id_perfil, compania_id_compania) VALUES ('$this->_user', '$this->_pass', '$this->_nombre', '$this->_telefono', '$this->_mail', '$this->_fecha', $this->_perfil, $this->_compania)";
//echo $sql;
...
$sql="UPDATE vigia.usuario SET usuario='$this->_user', pass='$this->_pass', nombre='$this->_nombre', telefono='$this->_telefono', email='$this->_mail', compania_id_compania=$this->_compania, perfil_id_perfil=$this->_perfil, activo='$this->_activo' WHERE id_usuario=$this->_id";
//echo $sql;
...
$row = pg_fetch_object($res);
 ...
 $this->_compania = $row->compania_id_compania;  
...
public function compania($db) {
	$sql="SELECT compania FROM vigia.usuario, vigia.compania WHERE vigia.compania.id_compania=vigia.usuario.compania_id_compania AND id_usuario=".$this->_id;
$res = $db->query($sql);
$row = pg_fetch_object($res);
